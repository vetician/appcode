...
// // Indexes
// veterinarianSchema.index({ name: 1, city: 1 });
// veterinarianSchema.index({ 'registration.value': 1 }, { unique: true });
// veterinarianSchema.index({ createdAt: -1 });
...
//   Object.keys(vet).forEach(key => {
//     if (key === 'refreshTokens') return;
//     if (typeof vet[key] === 'object' && vet[key] !== null && 'value' in vet[key]) {
//       publicProfile[key] = vet[key].value;
//     } else {
//       publicProfile[key] = vet[key];
//     }
//   });
...
//     'gender', 'city', 'experience', 'specialization',
//     'profilePhotoUrl', 'qualification', 'qualificationDocsUrl',
//     'registration', 'registrationProofUrl', 'identityProof', 'identityProofUrl'
//   ];

//   return fieldsToVerify.every(field => this[field]?.verified === true);
// };
